  ...
  if (error) return (
    <div className="space-y-4">
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 space-y-2">
        <p className="text-sm font-semibold text-amber-800">Sem snapshot ao vivo</p>
        <p className="text-xs text-amber-700">Execute o script local durante o pregão:</p>
        <code className="block text-[10px] bg-amber-100 rounded-lg px-3 py-2 text-amber-900 font-mono">
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold text-text-primary">Modo Operador</h1>
