...
10. **FECHADO em 22/09/2026, mesmo dia: validador passou a cobrar coerência de escala.** O item foi aberto e fechado na mesma sessão. `sealTradeCard` ganhou duas regras em `src/schemas/trade.ts`, o retorno declarado tem de estar na mesma ordem de grandeza da distância real entre entrada e alvo, e a perda na mesma ordem de grandeza da distância até a invalidação, com `FATOR_ESCALA_MAXIMO = 10` e normalização que aceita tanto `pct` quanto a unidade da entrada. O prompt ganhou as regras 6, 7 e 8, e a 8 resolveu sozinha o `sizing_pct_orcamento_risco`, que voltou para a escala 0 a 100. Deploy `c9fcdad5-b213-4661-82e1-06d407a1aed7`, corrida `d12fd9d6-4654-49e5-be9b-178f5b23378e` publicada com 2 trades coerentes, os dois com retorno e perda exatamente iguais à distância até alvo e invalidação. Gate 437 testes. Detalhe em `status/ESTADO.md`.
