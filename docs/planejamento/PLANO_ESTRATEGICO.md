...
- **PC-1. Política de `as_of` por praça.** [CERTO] às 06:30 BRT o snapshot mistura fechamento US
  ...
  e `WindowReturn.janela_as_of` já carregam a decisão. Falta o quant _usar_ isso e um teste que
...
_dentro_ da sua janela de treino já conhece o desfecho; há literatura de 2025 dedicada a detectar
...
- **[NOVO — significância].** [CERTO] a pergunta "quantos trades provam borda?" tem resposta na
  ...
  Prado, 2014) dão o nº de observações para um Sharpe ser significativo, _corrigido por
  multiple-testing_ — e cada ideia que você testa por dia é um trial que infla falso-positivo.
